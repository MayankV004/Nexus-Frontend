          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Card className="border-0 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 bg-gradient-to-br from-white to-orange-50 dark:from-gray-900 dark:to-orange-950">
              <CardHeader className="text-center pb-8">
                ...
                <CardDescription className="text-base leading-relaxed">
                  Advanced security with role-based access control, 2FA, and enterprise-grade encryption
                </CardDescription>
              </CardHeader>
            </Card>
        ...
        <div className="container mx-auto text-center max-w-4xl relative">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button
              size="lg"
              variant="outline"
              className="text-lg px-8 py-4 border-white text-white hover:bg-white hover:text-blue-600 transition-all duration-200"
            >
              Contact Sales
            </Button>
          </div>
